...
public class CrystalButton : MonoBehaviour
{
    ...
    public void CrystalAction()
    {
        ...
        if (Curent_player.name == "Knight")
        {
            ...
            set_enemy_to_destroy_from_crystal(2, CurFloorName, false);
            ...
            if (mScript.lang == "ru")
            {
                mScript.add_text("Вы выбираете использование магического кристалла, укажите врага которого хотите победить");
            }
            else if (mScript.lang == "en")
            {
                mScript.add_text("You choose to use a magic crystal, specify the enemy you want to defeat");
            }

            CrystalButton_.SetActive(false);

        }
        else if (Curent_player.name == "Barbarian")
        {
            ...
            if (mScript.lang == "ru")
            {
                mScript.set_current_move("Вы воспользовались магическим кристаллом и уничтожили всех врагов на соседних полях");
            }
            else if (mScript.lang == "en")
            {
                mScript.set_current_move("You used a magic crystal and destroyed all the enemies in the neighboring fields");
            }
        ...
        else if (Curent_player.name == "Mage")
        {
            ...
            set_enemy_to_destroy_from_crystal(4, CurFloorName, false);
        ...
        else if (Curent_player.name == "Priest")
        {
            ...
            if (mScript.lang == "ru")
            {
                mScript.set_current_move("Вы воспользовались магическим кристаллом и у вас восстановлены все жизни");
            }
            else if (mScript.lang == "en")
            {
                mScript.set_current_move("You have used a magic crystal and all your lives have been restored");
            }
